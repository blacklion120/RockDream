...
local deathfx = audio.loadSound("eunicefail.mp3")
...

{
	...
	local playersprite2 = graphics.newImageSheet( "eunicejump.png", { width = 500, height = 400, numFrames = 3} )
	local playersprite3 = graphics.newImageSheet( "euniceidle.png", { width = 500, height = 400, numFrames = 2} )
	local playersprite4 = graphics.newImageSheet( "eunicedie.png", { width = 500, height = 400, numFrames = 4} )
	local playersprite0 = graphics.newImageSheet( "eunicerun.png", { width = 500, height = 400, numFrames = 8} )
	local playersprite6 = graphics.newImageSheet( "euniceslide.png", { width = 500, height = 400, numFrames = 9} )
	local boardwarriorsprite5 = graphics.newImageSheet( "raain4.png", { width = 600, height = 600, numFrames = 2} )
	local playersprite7 = graphics.newImageSheet( "eunicedance.png", { width = 500, height = 400, numFrames = 2} )
	local playersprite8 = graphics.newImageSheet( "euniceboost.png", { width = 500, height = 400, numFrames = 8} )
...

{
				...
				{ name="jump", sheet=playersprite2, start=1, count=3,time = 750, loopCount = 1 },
				...
				{ name="dance", sheet=playersprite7, start=1, count=2,time = 650, loopCount = 0 },
...
---------------------------------------------------------------------------------------------------------------------------
	...
	if event.target.name == "player" and event.other.name == "endgamecollider" then  
		if event.phase == "began" then
			if player.isAlive == true then
				audio.stopWithDelay( 1000, { channel=backgroundchannel0 }  )
