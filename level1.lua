...
local deathfx = audio.loadSound("abfail.mp3")
...
--Backgrounds	
	...
	local layer = display.newImageRect( "h1.png", display.actualContentWidth * 2 ,display.actualContentHeight * 2.5 , true)
	layer.anchorX = 0
	layer.anchorY = 0
	...
	local layer3 = display.newImageRect( "h4.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer3.anchorX = 0
	layer3.anchorY = 0
	...
	local layer4 = display.newImageRect( "h6.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer4.anchorX = 0
	layer4.anchorY = 0
	...
	local layer6 = display.newImageRect( "h6.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer6.anchorX = 0
	layer6.anchorY = 0
	...
	local layer7 = display.newImageRect( "h3.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer7.anchorX = 0
	layer7.anchorY = 0
...

{
	...
	local playersprite2 = graphics.newImageSheet( "atikujump.png", { width = 500, height = 400, numFrames = 4} )
	local playersprite3 = graphics.newImageSheet( "atikuidle.png", { width = 500, height = 400, numFrames = 2} )
	local playersprite4 = graphics.newImageSheet( "atikudeath.png", { width = 500, height = 400, numFrames = 9} )
	local playersprite0 = graphics.newImageSheet( "realatikurunning.png", { width = 500, height = 400, numFrames = 8} )
	local playersprite6 = graphics.newImageSheet( "atikusliding.png", { width = 500, height = 400, numFrames = 9} )
	local playersprite7 = graphics.newImageSheet( "atikudanc.png", { width = 500, height = 400, numFrames = 2} )
	local playersprite8 = graphics.newImageSheet( "atikuboost.png", { width = 500, height = 400, numFrames = 8} )
...

{
				...
				{ name="run", sheet=playersprite0, start=1, count=8,time = 600, loopcount = 0 },
				...
				{ name="die", sheet=playersprite4, start=1, count=4,time = 300, loopCount = 1 },
				{ name="cry", sheet=playersprite4, start=4, count=5,time = 300, loopCount = 1 },
				...
				{ name="dance", sheet=playersprite7, start=1, count=2,time = 800, loopCount = 0 },
...
-- BokoHaram
	...
	local pickupsprite = graphics.newImageSheet( "danfo.png", { width = 500, height = 450, numFrames = 2} )
...

{
				...
				{ name="ride2", sheet=pickupsprite, start=1, count=2,time = 800, loopcount = 0 },
...
----------------------------------------------------------------------------------------------------------
		...
		local boss3 = display.newImageRect("oppod.png", 140, 90)
...
--obstacles
		...
		pickup.x, pickup.y =  pickupcollider.x - 800, 180
		pickup.xScale, pickup.yScale = 0.7, 0.8
...
function dropbomb35(  )
	if player.isAlive == true then
				...
				transition.moveTo(missile3, { x = boss3.x - 50, time = 1000, onComplete = function ( )
