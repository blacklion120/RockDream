...
local player = {}
camera:setBounds(display.contentWidth*0.5, display.contentWidth * 140, 70 , display.contentHeight - 150)
camera:track()
camera.damping = 3
local missile
local controls22 
...
--local runfx = audio.loadSound("runn.mp3")
...
local deathfx = audio.loadSound("death.mp3")
...
--Backgrounds	
	...
	local layer = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4 ,display.actualContentHeight * 1.6 , true)
	layer.anchorX = 0
	layer.anchorY = 0
	layer.x = 0 + display.screenOriginX 
	layer.y =   display.screenOriginY - 60


	

	local layer2 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer2.anchorX = 0
	layer2.anchorY = 0
	layer2.x =  screenW * 1.38 + layer.x 
	layer2.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer3 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer3.anchorX = 0
	layer3.anchorY = 0
	layer3.x =  screenW * 1.38 + layer2.x 
	layer3.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer4 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer4.anchorX = 0
	layer4.anchorY = 0
	layer4.x =  screenW * 1.38 + layer3.x 
	layer4.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer5 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer5.anchorX = 0
	layer5.anchorY = 0
	layer5.x =  screenW * 1.38 + layer4.x 
	layer5.y =   display.screenOriginY - 60
	--layer:setFillColor(0,0,0)

	local layer6 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer6.anchorX = 0
	layer6.anchorY = 0
	layer6.x =  screenW * 1.38 + layer5.x 
	layer6.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer7 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer7.anchorX = 0
	layer7.anchorY = 0
	layer7.x =  screenW * 1.38 + layer6.x 
	layer7.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)	

	local layer8 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer8.anchorX = 0
	layer8.anchorY = 0
	layer8.x =  screenW * 1.38 + layer7.x 
	layer8.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer9 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer9.anchorX = 0
	layer9.anchorY = 0
	layer9.x =  screenW * 1.38 + layer8.x 
	layer9.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer10 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer10.anchorX = 0
	layer10.anchorY = 0
	layer10.x =  screenW * 1.38 + layer9.x 
	layer10.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer11 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer11.anchorX = 0
	layer11.anchorY = 0
	layer11.x =  screenW * 1.38 + layer10.x 
	layer11.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer12 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer12.anchorX = 0
	layer12.anchorY = 0
	layer12.x =  screenW * 1.38 + layer11.x 
	layer12.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer13 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer13.anchorX = 0
	layer13.anchorY = 0
	layer13.x =  screenW * 1.38 + layer12.x 
	layer13.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer14 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer14.anchorX = 0
	layer14.anchorY = 0
	layer14.x =  screenW * 1.38 + layer13.x 
	layer14.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer15 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer15.anchorX = 0
	layer15.anchorY = 0
	layer15.x =  screenW *1.38 + layer14.x 
	layer15.y =   display.screenOriginY - 60
	--layer2:setFillColor(0,0,0)

	local layer16 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
	layer16.anchorX = 0
	layer16.anchorY = 0
	layer16.x =  screenW *1.38 + layer15.x 
	layer16.y =   display.screenOriginY - 60
...

{
	...
	local playersprite2 = graphics.newImageSheet( "buharijump.png", { width = 500, height = 400, numFrames = 4} )
	local playersprite3 = graphics.newImageSheet( "atikuidle.png", { width = 500, height = 400, numFrames = 2} )
	local playersprite4 = graphics.newImageSheet( "buharidie.png", { width = 500, height = 400, numFrames = 4} )
	local playersprite0 = graphics.newImageSheet( "buharirun.png", { width = 500, height = 400, numFrames = 8} )
	local playersprite6 = graphics.newImageSheet( "buharislide.png", { width = 500, height = 400, numFrames = 9} )
...

{
				...
				{ name="speed", sheet=playersprite0, start=1, count=8,time = 300, loopCount = 0 },
		...
		realplayer = display.newRect(1200, player.y , 100, 100)
...
function rainstart( )
	transition.moveTo(rain, {y = 160, time = 100})
end
...
-- BokoHaram
	...
	local pickupsprite = graphics.newImageSheet( "pickup.png", { width = 691, height = 257, numFrames = 6} )
...

{
				...
				{ name="ride2", sheet=pickupsprite, start=1, count=6,time = 800, loopcount = 0 },
...
----------------------------------------------------------------------------------------------------------
	local bosssprite = graphics.newImageSheet( "boss.png", { width = 450, height = 302, numFrames = 2} )
		local bosssequence =

{

				{ name="fly", sheet=bosssprite, start=1, count=2,time = 250, loopcount = 0 },
		...
		boss = display.newSprite(bosssprite, bosssequence)
		boss.x = boss1collider.x + 1000
		boss.y = 50
		boss.xScale = -0.3
		boss.yScale = 0.3
		boss:setSequence("fly")
		boss:play()
		boss.isDone = true
...
----------------------------------------------------------------------------------------------------------
	local bosssprite2 = graphics.newImageSheet( "boss.png", { width = 450, height = 302, numFrames = 2} )
		local bosssequence2 =

{

				{ name="fly", sheet=bosssprite2, start=1, count=2,time = 250, loopcount = 0 },
		...
		boss2 = display.newSprite(bosssprite2, bosssequence2)
		boss2.x = boss2collider.x + 1000
		boss2.y = 50
		boss2.xScale = -0.3
		boss2.yScale = 0.3
		boss2:setSequence("fly")
		boss2:play()
		boss2.isDone = true
...

{
		...
		votes2.x, votes2.y = votes.x + math.random(700, 900), 235
		votes2.xScale = 0.2
		votes2.yScale = 0.2
		...
		votes3.x, votes3.y = votes.x + math.random(1300, 1500), 240
		votes3.xScale = 0.2
		votes3.yScale = 0.2
		...
		votes5.x, votes5.y = votes.x + math.random(2100, 2300), 240
		votes5.xScale = 0.2
		votes5.yScale = 0.2
		...
		votes6.x, votes6.y = votes.x + math.random(2500, 2600), 240
		votes6.xScale = 0.2
		votes6.yScale = 0.2
		...
		votes7.x, votes7.y = votes.x + math.random(2800, 3000), 240
		votes7.xScale = 0.2
		votes7.yScale = 0.2
...
----------------------------------------------------------------------------------------------------------
	local bosssprite3 = graphics.newImageSheet( "boss.png", { width = 450, height = 302, numFrames = 2} )
		local bosssequence3 =

{

				{ name="fly", sheet=bosssprite3, start=1, count=2,time = 250, loopcount = 0 },
		...
		boss3 = display.newSprite(bosssprite3, bosssequence3)
		boss3.x = boss3collider.x + 1000
		boss3.y = 50
		boss3.xScale = -0.3
		boss3.yScale = 0.3
		boss3:setSequence("fly")
		boss3:play()
		boss3.isDone = true
		boss3:setFillColor(9,0,0)
...
---------------------------------------------------------------------------------------
		...
		youwongrap.x, youwongrap.y =  screenW * 0.4, screenH * 0.5
		youwongrap.alpha = 0
...
--obstacles
		...
		local alert = display.newImageRect("alert.png",30, 50)
		alert.x, alert.y =  1000, 150
		alert.isVisible = false
		transition.blink( alert, { time=500 } )

		local alert2 = display.newImageRect("alert.png",30, 50)
		alert2.x, alert2.y =  1000, 150
		alert2.isVisible = false
		transition.blink( alert2, { time=500 } )
		...
		local pickupcollider = display.newRect(obstacle4.x, 200 ,200, 400)
		...
		pickup.x, pickup.y =  pickupcollider.x - 800, 200 
...
-- control buttons
	...
	local controls11 = display.newImageRect("emptybtn.png", 80, 80)
	controls11.x, controls11.y = screenW * 0.1 , grass.y - 100
	controls11.alpha = 0.3
	controls11.isVisible = false
	controls11:addEventListener("touch", slide)

	local controls12 = display.newImageRect("emptybtn.png", 80, 80)
	...
	controls21 = display.newImageRect("rightbutton.png", 80, 80)
	...
	controls22 = display.newImageRect("leftbutton.png", 80, 80)
	controls22.x, controls22.y = screenW * 0.1 , grass.y - 100
...
------------------------------------------------------------------------------------------------------------------
	...
	function moving()
		if player.isAlive == true then
			...
			alert.x = player.x + 270
			alert2.x = player.x - 180
			alert2.y = 260
		end
	end
	...
	timer.performWithDelay(900, startgame, 1)
-------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------
		...
		local missileshape = { -58,-2, 15,-5, 15,6, -58,5 }
				...
				transition.moveTo(missile66, {x = player.x - 200, time = 3500, onComplete = function ( )
					missile66.y = missile66.y + 50
		...
		local function bokoharamattackstart( )
			if player.isAlive == true then
				...
				transition.moveTo(cab, {x = player.x + 2180, time = 6400, onComplete = function ( )
					transition.moveTo (cab, {x = cab.x + 600, y = 240, time = 1500, onComplete = function ( )
						controls11.isVisible = true
						controls12.isVisible = true
						bokoharamattack()					
					end})
...
---------------------------------------------------------------------------------------------------------------------------
	...
	function loadbgs3( )
		...
		if player.isAlive == true then
				...
				layer55 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer55.anchorX = 0
				layer55.anchorY = 0
				layer55.x =  screenW *1.38 + layer54.x 
				layer55.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer56 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer56.anchorX = 0
				layer56.anchorY = 0
				layer56.x =  screenW *1.38 + layer55.x 
				layer56.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer57 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer57.anchorX = 0
				layer57.anchorY = 0
				layer57.x =  screenW *1.38 + layer56.x 
				layer57.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)	

				local layer58 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer58.anchorX = 0
				layer58.anchorY = 0
				layer58.x =  screenW *1.38 + layer57.x 
				layer58.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer59 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer59.anchorX = 0
				layer59.anchorY = 0
				layer59.x =  screenW *1.38 + layer58.x 
				layer59.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer60 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer60.anchorX = 0
				layer60.anchorY = 0
				layer60.x =  screenW *1.38 + layer59.x 
				layer60.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)


				local layer61 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer61.anchorX = 0
				layer61.anchorY = 0
				layer61.x =  screenW *1.38 + layer60.x 
				layer61.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer62 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer62.anchorX = 0
				layer62.anchorY = 0
				layer62.x =  screenW *1.38 + layer61.x 
				layer62.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer63 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer63.anchorX = 0
				layer63.anchorY = 0
				layer63.x =  screenW *1.38 + layer62.x 
				layer63.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer64 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer64.anchorX = 0
				layer64.anchorY = 0
				layer64.x =  screenW *1.38 + layer63.x 
				layer64.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer65 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer65.anchorX = 0
				layer65.anchorY = 0
				layer65.x =  screenW *1.38 + layer64.x 
				layer65.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer66 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer66.anchorX = 0
				layer66.anchorY = 0
				layer66.x =  screenW *1.38 + layer65.x 
				layer66.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer67 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer67.anchorX = 0
				layer67.anchorY = 0
				layer67.x =  screenW *1.38 + layer66.x 
				layer67.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer68 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer68.anchorX = 0
				layer68.anchorY = 0
				layer68.x =  screenW *1.38 + layer67.x 
				layer68.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer69 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer69.anchorX = 0
				layer69.anchorY = 0
				layer69.x =  screenW *1.38 + layer68.x 
				layer69.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				layer70 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer70.anchorX = 0
				layer70.anchorY = 0
				layer70.x =  screenW *1.38 + layer69.x 
				layer70.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)
	...
	if player.isAlive == true then
			...
			layer35 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer35.anchorX = 0
			layer35.anchorY = 0
			layer35.x =  screenW *1.38 + layer34.x 
			layer35.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer36 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer36.anchorX = 0
			layer36.anchorY = 0
			layer36.x =  screenW *1.38 + layer35.x 
			layer36.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer37 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer37.anchorX = 0
			layer37.anchorY = 0
			layer37.x =  screenW *1.38 + layer36.x 
			layer37.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)	

			local layer38 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer38.anchorX = 0
			layer38.anchorY = 0
			layer38.x =  screenW *1.38 + layer37.x 
			layer38.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer39 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer39.anchorX = 0
			layer39.anchorY = 0
			layer39.x =  screenW *1.38 + layer38.x 
			layer39.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer40 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer40.anchorX = 0
			layer40.anchorY = 0
			layer40.x =  screenW *1.38 + layer39.x 
			layer40.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)


			local layer41 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer41.anchorX = 0
			layer41.anchorY = 0
			layer41.x =  screenW *1.38 + layer40.x 
			layer41.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer42 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer42.anchorX = 0
			layer42.anchorY = 0
			layer42.x =  screenW *1.38 + layer41.x 
			layer42.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer43 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer43.anchorX = 0
			layer43.anchorY = 0
			layer43.x =  screenW *1.38 + layer42.x 
			layer43.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer44 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer44.anchorX = 0
			layer44.anchorY = 0
			layer44.x =  screenW *1.38 + layer43.x 
			layer44.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer45 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer45.anchorX = 0
			layer45.anchorY = 0
			layer45.x =  screenW *1.38 + layer44.x 
			layer45.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer46 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer46.anchorX = 0
			layer46.anchorY = 0
			layer46.x =  screenW *1.38 + layer45.x 
			layer46.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer47 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer47.anchorX = 0
			layer47.anchorY = 0
			layer47.x =  screenW *1.38 + layer46.x 
			layer47.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer48 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer48.anchorX = 0
			layer48.anchorY = 0
			layer48.x =  screenW *1.38 + layer47.x 
			layer48.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer49 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer49.anchorX = 0
			layer49.anchorY = 0
			layer49.x =  screenW *1.38 + layer48.x 
			layer49.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer50 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer50.anchorX = 0
			layer50.anchorY = 0
			layer50.x =  screenW *1.38 + layer49.x 
			layer50.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer51 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6, true)
			layer51.anchorX = 0
			layer51.anchorY = 0
			layer51.x = screenW *1.38 + layer50.x
			layer51.y =   display.screenOriginY - 60


			

			local layer52 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer52.anchorX = 0
			layer52.anchorY = 0
			layer52.x =  screenW *1.38 + layer51.x 
			layer52.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			local layer53 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer53.anchorX = 0
			layer53.anchorY = 0
			layer53.x =  screenW *1.38 + layer52.x 
			layer53.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)

			layer54 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
			layer54.anchorX = 0
			layer54.anchorY = 0
			layer54.x =  screenW *1.38 + layer53.x 
			layer54.y =   display.screenOriginY - 60
			--layer2:setFillColor(0,0,0)
	...
	function loadbgs( )
		...
		if player.isAlive == true then
				...
				layer17 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer17.anchorX = 0
				layer17.anchorY = 0
				layer17.x =  screenW *1.38 + layer16.x 
				layer17.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer18 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer18.anchorX = 0
				layer18.anchorY = 0
				layer18.x =  screenW *1.38 + layer17.x 
				layer18.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer19 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer19.anchorX = 0
				layer19.anchorY = 0
				layer19.x =  screenW *1.38 + layer18.x 
				layer19.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer20 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer20.anchorX = 0
				layer20.anchorY = 0
				layer20.x =  screenW *1.38 + layer19.x 
				layer20.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer21 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer21.anchorX = 0
				layer21.anchorY = 0
				layer21.x =  screenW *1.38 + layer20.x 
				layer21.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer22 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer22.anchorX = 0
				layer22.anchorY = 0
				layer22.x =  screenW *1.38 + layer21.x 
				layer22.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer23 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer23.anchorX = 0
				layer23.anchorY = 0
				layer23.x =  screenW *1.38 + layer22.x 
				layer23.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer24 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer24.anchorX = 0
				layer24.anchorY = 0
				layer24.x =  screenW *1.38 + layer23.x 
				layer24.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer25 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer25.anchorX = 0
				layer25.anchorY = 0
				layer25.x =  screenW *1.38 + layer24.x 
				layer25.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer26 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer26.anchorX = 0
				layer26.anchorY = 0
				layer26.x =  screenW *1.38 + layer25.x 
				layer26.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer27 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer27.anchorX = 0
				layer27.anchorY = 0
				layer27.x =  screenW *1.38 + layer26.x 
				layer27.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer28 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer28.anchorX = 0
				layer28.anchorY = 0
				layer28.x =  screenW *1.38 + layer27.x 
				layer28.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer29 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer29.anchorX = 0
				layer29.anchorY = 0
				layer29.x =  screenW *1.38 + layer28.x 
				layer29.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer30 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer30.anchorX = 0
				layer30.anchorY = 0
				layer30.x =  screenW *1.38 + layer29.x 
				layer30.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer31 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6, true)
				layer31.anchorX = 0
				layer31.anchorY = 0
				layer31.x = screenW *1.38 + layer30.x
				layer31.y =   display.screenOriginY - 60


				local layer32 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer32.anchorX = 0
				layer32.anchorY = 0
				layer32.x =  screenW *1.38 + layer31.x 
				layer32.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				local layer33 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer33.anchorX = 0
				layer33.anchorY = 0
				layer33.x =  screenW *1.38 + layer32.x 
				layer33.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)

				layer34 = display.newImageRect( "bghouse2.png", display.actualContentWidth * 1.4,display.actualContentHeight * 1.6 , true)
				layer34.anchorX = 0
				layer34.anchorY = 0
				layer34.x =  screenW *1.38 + layer33.x 
				layer34.y =   display.screenOriginY - 60
				--layer2:setFillColor(0,0,0)
...
function youlose( )
 ...
 function batdeath( )
 	timer.performWithDelay(3500, backmenu, 1)
...
-----------------------------------------------------------------------------------------------------
	...
	function lastbgarrangement( )
		if player.isAlive == true then

			layer.x = screenW * 1.38 + layer70.x 
...
---------------------------------------------------------------------------------------------------------------------------
		...
		local endgamecollider = display.newRect(67500, 200 ,200, 400)
...
function killboko( )
	if player.isAlive == true then
		...
		player:setSequence("idle")
		player:play()
					transition.moveTo(boss2, {x = cab.x - 50, y = cab.y, time = 1200, onComplete =  function ( )
					if player.isAlive == true then
					...
					local options =
																{
																	...
																	count = 9,
																	time = 400,
																	loopCount = 3 -- Play just once and then stop.
																}
																audio.play(explosionfx)
																local explosionBurstSprite = display.newSprite( explosionBurstSpriteSheet, options )

																explosionBurstSprite.x = boss2.x
																explosionBurstSprite.y = boss2.y
																explosionBurstSprite.xScale = 1.6
																explosionBurstSprite.yScale = 1.3
																explosionBurstSprite:addEventListener( "sprite", spriteListenerGreenBurst )
																explosionBurstSprite:play()
																bombGroup:insert(explosionBurstSprite)
																display.remove(boss2)
...
function killedthem( )
	if player.isAlive == true then
				boss2.isDone = false
				transition.moveTo(boss2, {x = cab.x - 400, time = 1500, onComplete = function ( )
					...
					local missileshape = { -58,-2, 15,-5, 15,6, -58,5 }
							...
							transition.moveTo(missile66, {x = boss2.x, y = boss2.y,  time = 800, onComplete = function ( )
														audio.play(explosionfx)
...
function lastattack( )
	if player.isAlive == true then
				missile = display.newImageRect("missile.png", 30, 30)
				missile.x, missile.y = boss3.x, boss3.y 
				physics.addBody( missile, "dynamic" )
				missile.name = "missile"
				missile.gravityScale = 0
				missile.isSensor = true
...
function dropbomb35(  )
	if player.isAlive == true then
				...
				missile2 = display.newImageRect("missile.png", 30, 30)
				missile2.x, missile2.y = boss3.x, boss3.y 
				physics.addBody( missile2, "dynamic" )
				missile2.name = "missile2"
				...
				missile3.x, missile3.y = boss3.x, boss3.y 
				...
				missile4.x, missile4.y = boss3.x, boss3.y 
...
function dropbomb33(  )
	if player.isAlive == true then
				...
				transition.moveTo(missile, { x = boss3.x - 450, time = 1000, onComplete = function ( )
					timer.performWithDelay(1900, fallingbomb, 1)
				end})

				transition.moveTo(missile2, { x = boss3.x - 350, time = 1000, onComplete = function ( )
...
function youwon( )
	transition.fadeIn( youwongrap, {time = 500} )
	Runtime:removeEventListener("enterFrame", moving)
	timer.performWithDelay(6000, goasorock, 1)
end
						...
						if player.isAlive == true then
							if player.isSliding == false then
								...
								transition.moveTo(votes, {xScale = 0.02, yScale = 0.02, y = - 200, time = 400, onComplete = function ( )
									...
									votes.x, votes.y = votes.x + math.random(3700, 3750), math.random(210, 220) 
								end})
							end	
						end
					end		  		
					...
					if event.phase == "began" then
						if player.isAlive == true then
								...
								transition.moveTo(votes2, {xScale = 0.02, yScale = 0.02, y = - 200, time = 500, onComplete = function ( )
									...
									votes2.x, votes2.y = votes2.x + math.random(3900, 3950), 240 
								end})
						end
					end		  		
				end
					...
					if event.phase == "began" then
						if player.isAlive == true then
								...
								transition.moveTo(votes3, {xScale = 0.02, yScale = 0.02, y = - 200, time = 500, onComplete = function ( )
									...
									votes3.x, votes3.y = votes3.x + math.random(4100, 4150), 240 
								end})
						end
					end		  		
				end
					...
					if event.phase == "began" then
						if player.isAlive == true then
								...
								transition.moveTo(votes4, {xScale = 0.02, yScale = 0.02, y = - 200, time = 500, onComplete = function ( )
									...
									votes4.x, votes4.y = votes4.x + math.random(4300, 4350), 240 
								end})
					...
					if event.phase == "began" then
						if player.isAlive == true then
								...
								transition.moveTo(votes5, {xScale = 0.02, yScale = 0.02, y = - 200, time = 500, onComplete = function ( )
									...
									votes5.x, votes5.y = votes5.x + math.random(4500, 4550), 240 
								end})
						end
					end		  		
				end
					...
					if event.phase == "began" then
						if player.isAlive == true then
								...
								transition.moveTo(votes7, {xScale = 0.02, yScale = 0.02, y = - 200, time = 500, onComplete = function ( )
									...
									votes7.x, votes7.y = votes7.x + math.random(5000, 5100), math.random(230, 240) 
								end})
						end
					end		  		
				end
					...
					if event.phase == "began" then
						if player.isAlive == true then
								...
								transition.moveTo(votes8, {xScale = 0.02, yScale = 0.02, y = - 200, time = 500, onComplete = function ( )
									...
									votes8.x, votes8.y = votes8.x + math.random(5400, 5500), math.random(235, 250) 
								end})
						end
					end		  		
				end
				...
				if event.target.name == "player" and event.other.name == "endgamecollider" then  
					if event.phase == "began" then
						if player.isAlive == true then
							...
							timer.performWithDelay(2000, youwon, 1)
