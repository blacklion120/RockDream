...
local deathfx = audio.loadSound("bufail.mp3")
...
--Backgrounds	
	...
	local layer = display.newImageRect( "h6.png", display.actualContentWidth * 2 ,display.actualContentHeight * 2.5 , true)
	layer.anchorX = 0
	layer.anchorY = 0
	...
	local layer2 = display.newImageRect( "h4.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer2.anchorX = 0
	layer2.anchorY = 0
	...
	local layer3 = display.newImageRect( "h2.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer3.anchorX = 0
	layer3.anchorY = 0
	...
	local layer5 = display.newImageRect( "h5.png", display.actualContentWidth * 2,display.actualContentHeight * 2.5 , true)
	layer5.anchorX = 0
	layer5.anchorY = 0
...

{
	...
	local playersprite3 = graphics.newImageSheet( "buhariidle.png", { width = 500, height = 400, numFrames = 2} )
	...
	local playersprite7 = graphics.newImageSheet( "buharidance.png", { width = 500, height = 400, numFrames = 4} )
	local playersprite8 = graphics.newImageSheet( "buhariboost.png", { width = 500, height = 400, numFrames = 8} )
...

{
				...
				{ name="dance", sheet=playersprite7, start=1, count=4,time = 650, loopCount = 0 },
...
----------------------------------------------------------------------------------------------------------
		...
		local boss = display.newImageRect("oppod.png", 130, 90)
...
----------------------------------------------------------------------------------------------------------
		...
		local boss2 = display.newImageRect("oppoa.png", 130, 90)
...
----------------------------------------------------------------------------------------------------------
		...
		local boss3 = display.newImageRect("oppoy.png", 140, 90)
...
function youlose( )
 ...
 function batdeath( )
 	timer.performWithDelay(7500, backmenu, 1)
